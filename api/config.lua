...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("buffs",      nil,           "text_pos",         "BOTTOM")
  pfUI:UpdateConfig("buffs",      nil,           "text_offy",        "-3")
  pfUI:UpdateConfig("buffs",      nil,           "text_size",        "-1")
  ...
  pfUI:UpdateConfig("appearance", "cd",          "daythreshold",     "99")
  pfUI:UpdateConfig("appearance", "cd",          "hourthreshold",    "99")
  pfUI:UpdateConfig("appearance", "cd",          "minutethreshold",  "99")
  pfUI:UpdateConfig("appearance", "cd",          "lowthreshold",     "5")
  ...
  pfUI:UpdateConfig("appearance", "cd",          "hoursminutes",     "0")
  ...
  pfUI:UpdateConfig("appearance", "minimap",     "zonetext_loc",     "TOP")
  pfUI:UpdateConfig("appearance", "minimap",     "zonetext_size",    "14")
  pfUI:UpdateConfig("appearance", "minimap",     "zonetext_padding", "3")
  pfUI:UpdateConfig("appearance", "minimap",     "coordstext",       "mouseover")
  pfUI:UpdateConfig("appearance", "minimap",     "coords_loc",       "bottomleft")
  pfUI:UpdateConfig("appearance", "minimap",     "coords_size",      "12")
  pfUI:UpdateConfig("appearance", "minimap",     "coords_offx",      "0")
  pfUI:UpdateConfig("appearance", "minimap",     "coords_offy",      "0")
  pfUI:UpdateConfig("appearance", "minimap",     "pvpicon_loc",      "bottomright")
  pfUI:UpdateConfig("appearance", "minimap",     "pvpicon_size",     "16")
  pfUI:UpdateConfig("appearance", "minimap",     "pvpicon_offx",     "0")
  pfUI:UpdateConfig("appearance", "minimap",     "pvpicon_offy",     "0")
  ...
  pfUI:UpdateConfig("unitframes", "player",      "hideticksonfull",           "0")
  ...
  for _, unit in pairs(ufs) do
    ...
    pfUI:UpdateConfig("unitframes", unit,      "buffspacing",      "1")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "debuffspacing",    "1")
  ...
  for i=1,12 do
    ...
    pfUI:UpdateConfig("bars",     "bar"..i,      "cd_size",          "12")
    pfUI:UpdateConfig("bars",     "bar"..i,      "showkeybind",      "1")
    pfUI:UpdateConfig("bars",     "bar"..i,      "keybind_size",     "8")
    pfUI:UpdateConfig("bars",     "bar"..i,      "keybind_offset",   "0")
    pfUI:UpdateConfig("bars",     "bar"..i,      "showmacro",        "1")
    pfUI:UpdateConfig("bars",     "bar"..i,      "macro_size",       "9")
    pfUI:UpdateConfig("bars",     "bar"..i,      "macro_offset",     "0")
    pfUI:UpdateConfig("bars",     "bar"..i,      "showcount",        "1")
    pfUI:UpdateConfig("bars",     "bar"..i,      "count_size",       "11")
    pfUI:UpdateConfig("bars",     "bar"..i,      "count_offset",     "0")
  ...
  pfUI:UpdateConfig("bars",       nil,           "keybind_font",     "Interface\\AddOns\\pfUI\\fonts\\BigNoodleTitling.ttf")
  pfUI:UpdateConfig("bars",       nil,           "keybind_style",    "OUTLINE")
  pfUI:UpdateConfig("bars",       nil,           "keybind_align",    "RIGHT")
  pfUI:UpdateConfig("bars",       nil,           "keybind_color",    "1,1,0,1")
  pfUI:UpdateConfig("bars",       nil,           "macro_font",       "Interface\\AddOns\\pfUI\\fonts\\BigNoodleTitling.ttf")
  pfUI:UpdateConfig("bars",       nil,           "macro_style",      "OUTLINE")
  pfUI:UpdateConfig("bars",       nil,           "macro_align",      "LEFT")
  pfUI:UpdateConfig("bars",       nil,           "macro_color",      "1,1,1,1")
  pfUI:UpdateConfig("bars",       nil,           "count_font",       "Interface\\AddOns\\pfUI\\fonts\\BigNoodleTitling.ttf")
  pfUI:UpdateConfig("bars",       nil,           "count_style",      "OUTLINE")
  pfUI:UpdateConfig("bars",       nil,           "count_align",      "RIGHT")
  ...
  pfUI:UpdateConfig("nameplates", nil,           "cp_position",      "off")
  pfUI:UpdateConfig("nameplates", nil,           "cp_width",         "5")
  pfUI:UpdateConfig("nameplates", nil,           "cp_height",        "5")
