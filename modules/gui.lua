  ...
  do -- Generate Config UI
    ...
    for id, data in ipairs(unitframeSettings) do
      ...
      CreateGUIEntry(T["Unit Frames"], t, function()
		...
		if c == "player" or c == "target" then
          CreateConfig(nil, t .. " " .. T["Unit Frame Layout"], C.unitframes[c], "layout", "dropdown", pfUI.gui.dropdowns.uf_layout)
        end
        ...
        if C.unitframes[c].layout == "tukui" then
          CreateConfig(U[c], T["Caption"], nil, nil, "header")
          CreateConfig(U[c], T["Caption Height"], C.unitframes[c], "caption_height")
        end
        ...
        CreateConfig(U[c], T["Custom Font Shadow Color"], C.unitframes[c], "customfont_shadowcolor", "color")
        CreateConfig(U[c], T["Custom Font Shadow X-Offset"], C.unitframes[c], "customfont_shadowoffx")
        CreateConfig(U[c], T["Custom Font Shadow Y-Offset"], C.unitframes[c], "customfont_shadowoffy")
    ...
    CreateGUIEntry(T["Minimap"], T["Minimap"], function()
      ...
      CreateConfig(nil, T["Tracking"], nil, nil, "header")
      ...
      CreateConfig(nil, T["Zone Text"], nil, nil, "header")
      ...
      CreateConfig(nil, T["Zone Text Location"], C.appearance.minimap, "zonetext_loc", "dropdown", pfUI.gui.dropdowns.debuffposition)
      CreateConfig(nil, T["Zone Text Size"], C.appearance.minimap, "zonetext_size")
      CreateConfig(nil, T["Zone Text Padding"], C.appearance.minimap, "zonetext_padding")
	  
      CreateConfig(nil, T["Coordinates"], nil, nil, "header")
      ...
      CreateConfig(nil, T["Coordinates Location"], C.appearance.minimap, "coords_loc", "dropdown", pfUI.gui.dropdowns.minimap_cords_position)
      CreateConfig(nil, T["Coordinates Text Size"], C.appearance.minimap, "coords_size")
      CreateConfig(nil, T["Coordinates Text X Offset"], C.appearance.minimap, "coords_offx")
      CreateConfig(nil, T["Coordinates Text Y Offset"], C.appearance.minimap, "coords_offy")
	  
      CreateConfig(nil, T["PvP Icon"], nil, nil, "header")
      CreateConfig(nil, T["Show PvP Icon"], C.unitframes.player, "showPVPMinimap", "checkbox")
      CreateConfig(nil, T["PvP Icon Location"], C.appearance.minimap, "pvpicon_loc", "dropdown", pfUI.gui.dropdowns.minimap_cords_position)
      CreateConfig(nil, T["PvP Icon Size"], C.appearance.minimap, "pvpicon_size")
      CreateConfig(nil, T["PvP Icon Offset"], C.appearance.minimap, "pvpicon_offx")
      CreateConfig(nil, T["PvP Icon Y Offset"], C.appearance.minimap, "pvpicon_offy")
    end)
    ...
    CreateGUIEntry(T["Buffs"], T["Buffs/Debuffs"], function()
      ...
      CreateConfig(nil) -- spacer
      CreateConfig(U["buff"], T["Buff Icon Size"], C.buffs, "size")
      CreateConfig(U["buff"], T["Buff Icon Spacing"], C.buffs, "spacing")
      CreateConfig(nil) -- spacer
      ...
      CreateConfig(nil) -- spacer
      CreateConfig(U["buff"], T["Buff Duration Position"], C.buffs, "text_pos", "dropdown", pfUI.gui.dropdowns.buff_duration_position)
      CreateConfig(U["buff"], T["Buff Duration Y-Offset"], C.buffs, "text_offy")
      CreateConfig(U["buff"], T["Buff Duration Size"], C.buffs, "text_size")
    end)

    CreateGUIEntry(T["Buffs"], T["Totems"], function()
    ...
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(nil, T["Combo Points"], nil, nil, "header")
      CreateConfig(nil, T["Combo Points Position"], C.nameplates, "cp_position", "dropdown", pfUI.gui.dropdowns.uf_buff_position)
      CreateConfig(U["nameplates"], T["Combo Point Width"], C.nameplates, "cp_width")
      CreateConfig(U["nameplates"], T["Combo Point Height"], C.nameplates, "cp_height")
