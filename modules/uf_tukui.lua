pfUI:RegisterModule("uf_tukui", "vanilla:tbc", function ()
  ...
  function pfUI.uf.target.UpdateConfig()
    ...
    pfUI.uf.target:SetHeight(pfUI.uf.target:GetHeight() + 2*default_border + (C.global.font_size * 1.35) + tspacing)--increase target unitframe height
    ...
    pfUI.uf.target.caption:SetHeight(C.global.font_size + 2)--increase caption height
    ...
    pfUI.uf.target.caption:SetPoint("BOTTOMLEFT",pfUI.uf.target,"BOTTOMLEFT", 0, 2)--raise caption position
    ...
    --add new settings for powerRightText
    pfUI.uf.target.powerRightText:SetFont(pfUI.font_unit, 22, "NONE")
    pfUI.uf.target.powerRightText:SetParent(pfUI.uf.target.hp.bar)
    pfUI.uf.target.powerRightText:ClearAllPoints()
    pfUI.uf.target.powerRightText:SetPoint("RIGHT",pfUI.uf.target.hp.bar, "RIGHT", -default_border*2, 0)
  ...
  -- trigger updates
  --pfUI.uf.player.UpdateConfig()--disable player layout update
